...
/**
 * Brand marks below are fill-based single paths, unlike every other icon in this
 * file which is stroke-based. That is deliberate: these are the official glyph
 * shapes and redrawing them as strokes would misrepresent the brands.
 */
