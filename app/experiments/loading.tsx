...
import { ExperimentTabBarSkeleton, SitePanelSkeleton } from "@/components/features/ExperimentsTabsSkeleton";

/**
 * Experiments page loading skeleton
 */
export default function Loading() {
  ...
  return (
    ...
    >
      ...
      {/* Experiments Tabs - default to site panel */}
      <ExperimentTabBarSkeleton delay={300} />
      <SitePanelSkeleton delay={400} />
    </div>
  );
}